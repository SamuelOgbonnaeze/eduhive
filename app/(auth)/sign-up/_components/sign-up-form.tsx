            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="w-full ">
                        <Button className="flex mx-auto w-[200px] md:w-[330px] bg-[#0F52BA] text-white hover:bg-white hover:text-[#0F52BA] border border-[#0F52BA] rounded-[20px] " type="submit">Sign Up</Button>
                    </div>
                </form>
            </Form>
        </div>
